...
export default function MainGenerator({ initialType = 'website' }: { initialType?: QRType }) {
  const [pageState, setPageState] = useState<'landing' | 'editor' | 'success'>(
    initialType !== 'website' ? 'editor' : 'landing'
  );
